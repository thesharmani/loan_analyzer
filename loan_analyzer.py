...
print("The total of all loans is:", total_loan_costs)
...
average_loan_costs = sum(loan_costs) / loans_count
print("The average loan amount is:", average_loan_costs)
...
print("The future value is:", x)
y = loan.get("remaining_months")
print("The remaining months is:", y)
...
present_value = loan.get("future_value") / (1 + annual_discount_rate/12) ** loan.get("remaining_months")
...
print("The new present value is:", new_present_value)
